# Billionaires List - Data Analysis (Simple MS Excel Dashboard Project)
## Project Objective
...
## Dashboard
-	<a href="(https://github.com/pagonzales/Billionaires_List_Dashboard/blob/main/Dashboard.png)">View Dashboard</a>
## Project Insights
